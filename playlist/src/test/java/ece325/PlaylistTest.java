...
public class PlaylistTest extends TestCase {
    ...
    public void test_sortByArtist() {
        ...
        String lastSongArtist = aPlaylist.get(0).getArtist();
        for(Song ss: aPlaylist){
            assertTrue(ss.getArtist().compareTo(lastSongArtist) >= 0);
            lastSongArtist = ss.getArtist();
        }
    }
    ...
    public void test_sortByTitle() {
        ...
        String lastSongTitle = aPlaylist.get(0).getTitle();
        for(Song ss: aPlaylist){
            assertTrue(ss.getTitle().compareTo(lastSongTitle) >= 0);
            lastSongTitle = ss.getTitle();
        }
    }
}
